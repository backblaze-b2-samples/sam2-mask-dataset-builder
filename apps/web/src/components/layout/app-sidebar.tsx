...
const navItems = [
  ...
  { title: "Studio", href: "/studio", icon: Wand2 },
  { title: "Dataset", href: "/dataset", icon: Layers },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-sam2-mask-builder"
          target="_blank"
